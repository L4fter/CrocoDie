namespace Assets.Src.Controller
{
    ...
    public class TutorialController : MonoBehaviour
    {
        ...
        private static readonly string manFirstHint = "Hey! Your croco is sleeping, press Space to move and wake him up";
        ...
        void Start()
        {
            Debug.Log(GameController.Instance.PlayerControlsCroco);
